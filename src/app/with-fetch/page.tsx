...
const code = `export const revalidate = 4;
      ...
      <div className="text-lg">
        <ul className="list-disc list-inside">
          ...
          <li>
            ...
            <span className="text-yellow-500"> next.revalidate</span> overrides
            the route segment configuration and revalidate each data cache
            individually. <br />
            Fetch without specifying revalidate time will use the lowest time.
            In this case tokyo time is updating when seoul time got updated
            every 2 seconds.
            <br />
            Also revalidate on-demand is not working
          </li>
        </ul>
      </div>
